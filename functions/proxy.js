export async function onRequest(context) {
  ...
  try {
    ...
    const response = await fetch(targetUrl, {
      headers: {
        'User-Agent': 'Mozilla/5.0 (Linux; Android 12; SM-G991B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36',
        ...
        <script>
          (function() {
            ...
            document.addEventListener('DOMContentLoaded', function() {
              ...
              links.forEach(function(l) { l.setAttribute('target', '_self'); });
            });
          })();
        </script>
      `;
    ...
    return new Response(`
      ...
      <body>
        ...
        <h1>${escapedUrl}</h1>
        <p class="sub">Launching inside secure NEXORA container...</p>
